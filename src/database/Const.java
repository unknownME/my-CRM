...
public class Const {
	...
	public static final String CLIENT_AGE = "cage";
	public static final String CLIENT_GENDER = "cgender";
	public static final String CLIENT_ACTIVITY = "cactivity";
	public static final String CLIENT_MASSAGE_TYPE = "cmassagetype";
